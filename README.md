...
Уверенный Automation QA-инженер с опытом ручного и автоматизированного тестирования веб и мобильных приложений в нагруженных и требовательных к качеству системах. 
...
Базовый опыт автоматизации на Python (PyTest + requests, Selenium, Playwright): написание автотестов для API и UI, запуск в CI, отчёты Allure.
