# Привет, меня зовут Макс! <img src="https://raw.githubusercontent.com/MartinHeinz/MartinHeinz/master/wave.gif" width="30px" height="30px"/>

### 👨‍💻 Обо мне:

Уверенный QA-инженер с опытом ручного тестирования веб и мобильных приложений в нагруженных и требовательных к качеству системах. 
Веду весь цикл: от анализа требований и тест-документации до проверки бизнес-логики, UI, интеграций и API. Уверенно работаю с SQL, REST, логами и баг-трекингом. 
Выстраиваю эффективное взаимодействие в команде, менторю, беру задачи под самостоятельное ведение и участвую в релизах. Ориентирован на стабильные релизы и результат на проде.

Базовый опыт автоматизации на Python (PyTest + requests, Selenium): написание автотестов для API и UI, запуск в CI, отчёты Allure.

Ценю системность, автоматизацию и умею находить уязвимости там, где другие их не замечают. Ориентирован на стабильные релизы и реальную пользу для бизнеса.
...
Управление тестированием и баг-трекинг:
<p align="center">
  <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/jira/jira-original.svg" title="Jira" alt="Jira" width="40" height="40"/>
  <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/95/YouTrack_Icon.png/1200px-YouTrack_Icon.png" title="YouTrack" alt="YouTrack" width="40" height="40"/>
  <img src="https://api.nuget.org/v3-flatcontainer/testit.apiclient/3.2.0/icon" title="testIT" alt="testIT" width="40" height="40"/>
  ...
  <img src="https://is1-ssl.mzstatic.com/image/thumb/Purple221/v4/8f/a1/13/8fa113c9-bdab-ff1b-0945-711a55fb1422/Xcode-0-85-220-0-6-0-0-2x-sRGB-0-0.png/1200x630bb.png" title="xcode" alt="xcode" width="40" height="40"/>
  ...
  <img src="https://i.ytimg.com/vi/jtFw8gNeK1M/maxresdefault.jpg" title="Bash" alt="Bash" width="40" height="40"/>
...
- 🧾 [<a href="https://github.com/M4xMal1nin/Web-shop-testing/blob/main/README.md">Артефакты для тестирования интернет-магазина</a>](#)
- 🧪 [API тестирование](#)
- 💥 [SQL](#)
- 🧰 [MongoDB](#)
