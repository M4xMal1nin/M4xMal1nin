...
Я QA Engineer, увлечён тестированием и автоматизацией.
...
Изучаю автоматизацию на Python (Pytest, Selenium), пишу автотесты, создаю чек-листы, тест-кейсы и баг-репорты, разбираюсь в STLC, и работе с REST API.
