...
Уверенный QA-инженер с опытом ручного тестирования веб и мобильных приложений в нагруженных и требовательных к качеству системах. Веду весь цикл: от анализа требований и тест-документации до проверки бизнес-логики, UI, интеграций и API. Уверенно работаю с SQL, REST, логами и баг-трекингом. Выстраиваю эффективное взаимодействие в команде, менторю, беру задачи под самостоятельное ведение и участвую в релизах. Ориентирован на стабильные релизы и результат на проде.
...
Люблю всё систематизировать, и находить уязвимости там, где другие их не видят.
